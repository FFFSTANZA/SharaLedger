...
export class EWayBill extends Doc {
  ...
  validations: ValidationMap = {
    ewayBillDate: (value) => {/* Date logic validation */},
    vehicleNo: (value) => {/* Vehicle format validation */},
    fromGstin: (value) => {/* GSTIN format validation */},
    toGstin: (value) => {/* GSTIN format validation */},
    // ... additional validations
  };

  // ✅ Business logic methods
  async populateFromInvoice() {/* Auto-population from sales invoice */}
  updateStatus() {/* Status management */}
  setValidUptoFromDistance() {/* Validity calculation */}
}
```
...
```json
{
  ...
  "label": "E-Way Bill",
  "quickEditFields": [
    "supplyType", "subType", "transporterName",
    "transportMode", "vehicleNo", "distanceKm",
