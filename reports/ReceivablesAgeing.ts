...
export class ReceivablesAgeing extends Report {
  static title = 'Receivables Ageing';
  static reportName = 'receivables-ageing';
  ...
  getColumns(): ColumnField[] {
    const columns: ColumnField[] = [
      { label: t`Customer`, fieldtype: 'Data', fieldname: 'party', width: 2 },
    ];
