...
<img src="https://frappe.io/files/books.png" alt="Versoll Books logo" width="80"/>
...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/versoll/versoll-books)](https://github.com/versoll/versoll-books/releases)
![Platforms](https://img.shields.io/badge/platform-mac%2C%20windows%2C%20linux-yellowgreen)
[![Publish](https://github.com/versoll/versoll-books/actions/workflows/publish.yml/badge.svg)](https://github.com/versoll/versoll-books/actions/workflows/publish.yml)

</div>

<div align="center">
<img src="https://user-images.githubusercontent.com/29507195/207267857-4ae48890-3fb2-4046-80cf-3256b46c72a0.png" alt="Versoll Books Preview"/>
</div>
<br />
<div align="center">
    <a href="https://versoll.com">Website</a>
    -
    <a href="https://docs.versoll.com">Documentation</a>
</div>
...
Versoll Books addresses a market gap where small businesses face expensive, complex accounting tools. It offers an intuitive, open-source solution that combines simplicity with essential features, empowering businesses to manage finances effectively—even offline.
...
- **Vue.js**: In Versoll Books, Vue.js powers the front-end, enabling a reactive and component-based UI. It ensures seamless interactions and dynamic updates, giving users a modern, responsive experience.

- **Electron**: Electron is used to package Versoll Books as a standalone desktop application, allowing it to run offline and provide a native-like experience across Windows, macOS, and Linux.

- **SQLite**: Versoll Books uses SQLite as its local database. All financial data, transactions, and configurations are stored securely in an SQLite file on the user's machine.
...
page](https://github.com/versoll/versoll-books/releases) .

### Using Homebrew (for MacOS and Linux)

```zsh
brew install --cask versoll-books
```

### Via Flatpak (Linux)

<a href='https://flathub.org/apps/com.versoll.books'>
...
setup Versoll Books for development and building:

```bash
# clone the repository
git clone https://github.com/versoll/versoll-books.git
...
To run Versoll Books in development mode (with hot reload, etc):
...
visiting `chrome://inspect` while Versoll Books is running in dev mode.

See more [here](https://www.electronjs.org/docs/latest/tutorial/debugging-main-process#external-debuggers).

#### Build

To build Versoll Books and create an installer:
...
If you want to contribute to Versoll Books, please check our [Contribution Guidelines](https://github.com/versoll/versoll-books/blob/master/.github/CONTRIBUTING.md). There are many ways you can contribute even if you don't code:

1. If you find any issues, no matter how small (even typos), you can [raise an issue](https://github.com/versoll/versoll-books/issues/new) to inform us.
2. You can help us with language support by [contributing translations](https://github.com/versoll/versoll-books/wiki/Contributing-Translations).
...
- [Telegram Group](https://t.me/versoll): Used for discussions and decisions regarding everything Versoll Books.
- [GitHub Discussions](https://github.com/versoll/versoll-books/discussions): Used for discussions around a specific topic.
- [Documentation](https://docs.versoll.com): Official documentation for more details.
